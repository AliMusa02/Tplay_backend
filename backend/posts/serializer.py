...
class PostSerializer(serializers.ModelSerializer):
    ...
    author_team_id = serializers.SerializerMethodField()

    class Meta:
        model = Posts
        fields = ["id", "content", "created_at", "post_pic", "author_id",
                  'author_username', 'author_profilePic', 'author_team_name', 'author_team_id']
    ...
    def get_author_team_id(self, obj):
        try:
            return obj.author.team.id
        except AttributeError:
            return None
