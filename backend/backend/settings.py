...
CSRF_TRUSTED_ORIGINS = [
    "https://teamplaybackend.up.railway.app", "http://127.0.0.1:8000", "localhost", "http://localhost:5173"]
...
# postgresql: // postgres: KenaIWuCtwplZQfMxsiaBMytYnbqDURA@mainline.proxy.rlwy.net: 45856/railway
